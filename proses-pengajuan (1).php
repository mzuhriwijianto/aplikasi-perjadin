...
if(isset($_POST['id_pegawai'])) {
    ...
    $insert_pengajuan = mysqli_query($conn, "INSERT INTO pengajuan (id_pegawai, tgl_pengajuan, tgl_berangkat, tgl_pulang, judul_perjadin, kota_tujuan, status_disetujui)
    VALUES ('$id_pegawai', '$tgl_pengajuan', '$tgl_berangkat', '$tgl_pulang', '$judul_perjadin', '$kota_tujuan', '$status_disetujui')");
